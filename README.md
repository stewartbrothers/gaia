...
> **Latest: v0.5.0** — released 2026-05-25. See [`CHANGELOG.md`](CHANGELOG.md) for release notes.
...
- **Homebrew tap** — `brew tap stewartbrothers/gaia https://github.com/stewartbrothers/homebrew-gaia`
